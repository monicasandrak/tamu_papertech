                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <a href="/pasien_tamu/detail/{{$data->id_tamu}}" class="text-success"><i class="material-icons">visibility</i></a>
                                        <a href="/pasien_tamu/edit/{{$data->id_tamu}}" class="text-primary"><i class="material-icons">mode_edit</i></a>
